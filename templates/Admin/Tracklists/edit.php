...
$this->assign('title', __('Edit') . ' ' . __('Tracklist'));
?>
				<div id="form-row" class="tracklists row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Tracklist') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($tracklist, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: position: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="position"><?= __('Position') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('position', ['label' => __('Position'), 'placeholder' => __('Position'), 'class' => 'form-control', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: duration: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="duration"><?= __('Duration') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('duration', ['label' => __('Duration'), 'placeholder' => __('Duration'), 'class' => 'form-control', 'empty' => false]); ?>
											...
											<!-- 2. STRING: lyrics_checked_user_id: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="lyrics-checked-user-id"><?= __('Lyrics Checked User Id') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('lyrics_checked_user_id', ['label' => __('Lyrics Checked User Id'), 'placeholder' => __('Lyrics Checked User Id'), 'class' => 'form-control', 'empty' => false]); ?>
										...
										<!-- TabPanel: tabPanelLyrics -->
										<!-- 10. TEXT: lyrics: text  required -->
										<div class="tab-pane fade" id="tabPanelLyrics" role="tabpanel" aria-labelledby="tabLyrics" tabindex="0">
											<div class="row mb-3">
												<div class="col-sm-12">
													<?= $this->Form->control('lyrics', ['id' => 'lyrics', 'label' => false, 'class' => 'summernote', 'empty' => false]); ?>

												</div>
											</div>
										</div><!-- /.TabPanel: tabPanelLyrics -->
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitSummerNote('lyrics', 400, '<?= __("Here you can write the note") ?>...') // Init SummerNote for lyrics.
	jeffAdminInitDateTimePicker('last_used'<?= $tracklist->last_used !== null ? ", '" . $tracklist->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
