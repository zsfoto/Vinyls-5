						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Image') ?></h3>
...
<?php } ?>
											...
											<div class="row"><!-- 1. -->
												...
												<div class="col-sm-10 p-1 link">
													<?= $image->hasValue('album') ? $this->Html->link($image->album->name, ['controller' => 'Albums', 'action' => 'view', $image->album->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 2. -->
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Uri150') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($image->uri150) ?>
											...
											<div class="row"><!-- 3. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Width') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($image->width) ?><!-- 3.b -->
												</div>
											</div>
											<div class="row"><!-- 3. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Height') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($image->height) ?><!-- 3.b -->
												</div>
											</div>
											<div class="row"><!-- 4. -->
