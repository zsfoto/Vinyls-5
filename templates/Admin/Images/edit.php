...
$this->assign('title', __('Edit') . ' ' . __('Image'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Image') ?></h3>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $image->last_used !== null ? ", '" . $image->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
