...
$this->assign('title', __('Edit') . ' ' . __('Genre'));
?>
				<div id="form-row" class="genres row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Genre') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Genres", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($genre, ['id' => 'main-form']) ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $genre->last_used !== null ? ", '" . $genre->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
