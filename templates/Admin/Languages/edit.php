...
$this->assign('title', __('Edit') . ' ' . __('Language'));
?>
				<div id="form-row" class="languages row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Language') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($language, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: short_name: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="short-name"><?= __('Short Name') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('short_name', ['label' => __('Short Name'), 'placeholder' => __('Short Name'), 'class' => 'form-control', 'empty' => false]); ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $language->last_used !== null ? ", '" . $language->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
