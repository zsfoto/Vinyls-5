						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Condition') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>
								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Conditions", "action" => "index", "_full" => true],
...
<?php if (!empty($condition->albums_users)) : ?>
												<li><?= $this->Html->link(__('Albums Users') . '...', ['controller' => 'Albums Users', 'action' => 'index', 'parent', 'condition', $condition->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
<?php if (!empty($condition->tracklists)) : ?>
												<li><?= $this->Html->link(__('Tracklists') . '...', ['controller' => 'Tracklists', 'action' => 'index', 'parent', 'condition', $condition->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php } ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Long Name') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($condition->long_name) ?>
...
<?php /*
											<div class="row"><!-- 6. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Text->autoParagraph(h($condition->description)) ?>
												...
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreDescription" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($condition->description) ?>
...
<?php } ?>
											...
											<tbody>
												<?php foreach ($condition->albums_users as $albumsUsers) : ?>
...
<?php } ?>
											...
											<tbody>
												<?php foreach ($condition->tracklists as $tracklists) : ?>
