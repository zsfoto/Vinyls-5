...
$this->assign('title', __('Edit') . ' ' . __('Condition'));
?>
				<div id="form-row" class="conditions row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Condition') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($condition, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: long_name: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="long-name"><?= __('Long Name') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('long_name', ['label' => __('Long Name'), 'placeholder' => __('Long Name'), 'class' => 'form-control', 'empty' => false]); ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $condition->last_used !== null ? ", '" . $condition->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
