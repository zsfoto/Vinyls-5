						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Artist') ?></h3>
...
<?php if (!empty($artist->albums)) : ?>
												<li><?= $this->Html->link(__('Albums') . '...', ['controller' => 'Albums', 'action' => 'index', 'parent', 'artist', $artist->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php } ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('ArtistJoin') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($artist->artistJoin) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Anv') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($artist->anv) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Tracks') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($artist->tracks) ?>
											...
											<div class="row"><!-- 2. -->
												...
												<div class="col-sm-10 p-1">
													<?= h($artist->resource_url) ?>

												</div>
											</div>
											<div class="row"><!-- 3. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('ResourceId') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($artist->resourceId) ?><!-- 3.b -->
												</div>
											</div>
											<div class="row"><!-- 4. -->
