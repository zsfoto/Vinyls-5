 ...
 * @var string[]|\Cake\Collection\CollectionInterface $shelves
...
$this->assign('title', __('Edit') . ' ' . __('Albums User'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Albums User') ?></h3>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDatePicker('last_play'<?= $albumsUser->last_play !== null ? ", '" . $albumsUser->last_play->format('Y-m-d') . "'" : "" ?>)
	jeffAdminInitDateTimePicker('last_used'<?= $albumsUser->last_used !== null ? ", '" . $albumsUser->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
