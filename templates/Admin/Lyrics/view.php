						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Lyric') ?></h3>
...
<?php } ?>
											...
											<div class="row"><!-- 1. -->
												...
												<div class="col-sm-10 p-1 link">
													<?= $lyric->hasValue('tracklist') ? $this->Html->link($lyric->tracklist->title, ['controller' => 'Tracklists', 'action' => 'view', $lyric->tracklist->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('HttpGetUrl') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->httpGetUrl) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('TrackId') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->TrackId) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricChecksum') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricChecksum) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricId') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricId) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricSong') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricSong) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricArtist') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricArtist) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricUrl') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricUrl) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricCovertArtUrl') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricCovertArtUrl) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricRank') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricRank) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('LyricCorrectUrl') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($lyric->LyricCorrectUrl) ?>
...
<?php /*
											<div class="row"><!-- 6. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Lyric') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Text->autoParagraph(h($lyric->Lyric)) ?>
...
*/ ?>
										...
										<!-- TAB for: Lyric text field -->
										<div class="tab-pane fade" id="tabPanelLyric" role="tabpanel" aria-labelledby="tabLyric" tabindex="0">
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreLyric" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($lyric->Lyric) ?>
