						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Label') ?></h3>
...
<?php if (!empty($label->albums)) : ?>
												<li><?= $this->Html->link(__('Albums') . '...', ['controller' => 'Albums', 'action' => 'index', 'parent', 'label', $label->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php } ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Entity Type') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($label->entity_type) ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Catno') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($label->catno) ?>
											...
											<div class="row"><!-- 2. -->
												...
												<div class="col-sm-10 p-1">
													<?= h($label->resource_url) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Entity Type Name') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($label->entity_type_name) ?>
											...
											<div class="row"><!-- 3. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($label->ext_id) ?><!-- 3.b -->
												</div>
											</div>
											<div class="row"><!-- 4. -->
...
<?php /*
											<div class="row"><!-- 6. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Text->autoParagraph(h($label->json)) ?>
												...
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreJson" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($label->json) ?>
...
<?php } ?>
											...
											<tbody>
												<?php foreach ($label->albums as $albums) : ?>
