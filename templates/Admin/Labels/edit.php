...
$this->assign('title', __('Edit') . ' ' . __('Label'));
?>
				<div id="form-row" class="labels row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Label') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Labels", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($label, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 2. STRING: entity_type: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="entity-type"><?= __('Entity Type') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('entity_type', ['label' => __('Entity Type'), 'placeholder' => __('Entity Type'), 'class' => 'form-control', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: catno: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="catno"><?= __('Catno') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('catno', ['label' => __('Catno'), 'placeholder' => __('Catno'), 'class' => 'form-control', 'empty' => false]); ?>
											...
											<!-- 3. INTEGER: ext_id: integer  required -->
											<div class="mb-3 form-group row number required">
												...
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<?= $this->Form->control('ext_id', ['class' => 'form-control', 'placeholder' => __('Ext Id'), 'data-decimals' => '0', 'min' => '0', 'max' => '999999999999', 'step' => '1', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: entity_type_name: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="entity-type-name"><?= __('Entity Type Name') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('entity_type_name', ['label' => __('Entity Type Name'), 'placeholder' => __('Entity Type Name'), 'class' => 'form-control', 'empty' => false]); ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $label->last_used !== null ? ", '" . $label->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
