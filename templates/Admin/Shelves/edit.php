...
$this->assign('title', __('Edit') . ' ' . __('Shelf'));
?>
				<div id="form-row" class="shelves row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Shelf') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($shelf, ['id' => 'main-form']) ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $shelf->last_used !== null ? ", '" . $shelf->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
