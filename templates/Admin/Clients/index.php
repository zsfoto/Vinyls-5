...
<?php } ?>
											<td class="string link user-id" value="<?= $client->user_id ?>"><?= $client->hasValue('user') ? $this->Html->link($client->user->name, ['controller' => 'Users', 'action' => 'view', $client->user->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span></td>
											<td class="string name" value="<?= $client->name ?>"><?= h($client->name) ?></td>
											<td class="string address" value="<?= $client->address ?>"><?= h($client->address) ?></td>
											<td class="string phone" value="<?= $client->phone ?>"><?= h($client->phone) ?></td>
											<td class="string email" value="<?= $client->email ?>"><?= h($client->email) ?></td>
											<td class="datetime last-used" value="<?= $client->last_used ?>"><?= h($client->last_used) ?></td>
<?php if($config['show_pos']){ ?>
