						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Usergroup') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>
								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Usergroups", "action" => "index", "_full" => true],
...
<?php if (!empty($usergroup->users)) : ?>
												<li><?= $this->Html->link(__('Users') . '...', ['controller' => 'Users', 'action' => 'index', 'parent', 'usergroup', $usergroup->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
												...
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreDescription" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($usergroup->description) ?>
...
<?php if (!empty($usergroup->users)): ?>
									...
									<div class="tab-pane fade show active p-0" id="nav-users" role="tabpanel" aria-labelledby="nav-users-tab" tabindex="0">
