						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Albums Extraartist') ?></h3>
...
<?php } ?>
											<div class="row"><!-- 1. -->
												...
												<div class="col-sm-10 p-1 link">
													<?= $albumsExtraartist->hasValue('album') ? $this->Html->link($albumsExtraartist->album->name, ['controller' => 'Albums', 'action' => 'view', $albumsExtraartist->album->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Role') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($albumsExtraartist->role) ?>
											...
											<div class="row"><!-- 3. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Number->format($albumsExtraartist->extraartist_id) ?><!-- 3.b -->
												</div>
											</div>
											<div class="row"><!-- 4. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Last Used') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($albumsExtraartist->last_used) ?>
