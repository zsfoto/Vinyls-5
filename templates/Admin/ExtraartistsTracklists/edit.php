 ...
 * @var \App\Model\Entity\ExtraartistsTracklist $extraartistsTracklist
...
$this->assign('title', __('Edit') . ' ' . __('Extraartists Tracklist'));
?>
				<div id="form-row" class="extraartistsTracklists row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Extraartists Tracklist') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Extraartists Tracklists", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($extraartistsTracklist, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 3. INTEGER: extraartist_id: integer  required -->
											<div class="mb-3 form-group row number required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="extraartist-id"><?= __('Extraartist Id') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<?= $this->Form->control('extraartist_id', ['class' => 'form-control', 'placeholder' => __('Extraartist Id'), 'data-decimals' => '0', 'min' => '0', 'max' => '999999999999', 'step' => '1', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 2. STRING: role: string  required -->
											<div class="mb-3 form-group row text required">
												...
												<div class="col-md-9">
													<?= $this->Form->control('role', ['label' => __('Role'), 'placeholder' => __('Role'), 'class' => 'form-control', 'empty' => false]); ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $extraartistsTracklist->last_used !== null ? ", '" . $extraartistsTracklist->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
