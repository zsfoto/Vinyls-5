 ...
 * @var \Cake\Collection\CollectionInterface|string[] $tracklists
 */
?>
<?php
...
$this->assign('title', __('Add') . ' ' . __('Extraartists Tracklist'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-plus fa-spin"></i> <?= __('Add') ?>: <?= __('Extraartists Tracklist') ?></h3>
