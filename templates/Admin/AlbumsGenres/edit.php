 ...
 * @var \App\Model\Entity\AlbumsGenre $albumsGenre
...
$this->assign('title', __('Edit') . ' ' . __('Albums Genre'));
?>
				<div id="form-row" class="albumsGenres row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Albums Genre') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Albums Genres", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($albumsGenre, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 1. SELECT: genre_id: integer  required -->
											<div class="mb-3 form-group row select required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="genre-id"><?= __('Genre Id') ?>:</label>
												<div class="col-md-4">
													<?= $this->Form->control('genre_id', ['options' => $genres, 'placeholder' => __('Genre Id'), 'class' => 'form-control select2', 'data-live-search' => false, 'data-container' => 'body', 'data-size' => '6', 'empty' => false]);	?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $albumsGenre->last_used !== null ? ", '" . $albumsGenre->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
