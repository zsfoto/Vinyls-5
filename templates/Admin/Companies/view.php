...
<?php if (!empty($company->albums)) : ?>
												<li><?= $this->Html->link(__('Albums') . '...', ['controller' => 'Albums', 'action' => 'index', 'parent', 'company', $company->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php } ?>
											...
											<tbody>
												<?php foreach ($company->albums as $albums) : ?>
