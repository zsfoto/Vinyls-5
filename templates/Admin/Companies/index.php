...
<?php } ?>
											...
											<th class="string ext-id"><?= $this->Paginator->sort('ext_id') ?></th><!-- H.1. -->
...
<?php } ?>
											...
											<td class="string entity-type" value="<?= $company->entity_type ?>"><?= h($company->entity_type) ?></td>
											<td class="string catno" value="<?= $company->catno ?>"><?= h($company->catno) ?></td>
											<td class="string resource-url" value="<?= $company->resource_url ?>"><?= h($company->resource_url) ?></td>
											<td class="string ext-id" value="<?= $company->ext_id ?>"><?= h($company->ext_id) ?></td>
											<td class="string entity-type-name" value="<?= $company->entity_type_name ?>"><?= h($company->entity_type_name) ?></td>
											<td class="datetime last-used" value="<?= $company->last_used ?>"><?= h($company->last_used) ?></td>
<?php if($config['show_pos']){ ?>
