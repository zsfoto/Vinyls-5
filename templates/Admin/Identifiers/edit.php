 ...
 * @var \App\Model\Entity\Identifier $identifier
...
$this->assign('title', __('Edit') . ' ' . __('Identifier'));
?>
				<div id="form-row" class="identifiers row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Identifier') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Identifiers", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($identifier, ['id' => 'main-form']) ?>
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="type"><?= __('Type') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('type', ['label' => __('Type'), 'placeholder' => __('Type'), 'class' => 'form-control', 'empty' => true]); ?>
											...
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="value"><?= __('Value') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('value', ['label' => __('Value'), 'placeholder' => __('Value'), 'class' => 'form-control', 'empty' => true]); ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $identifier->last_used !== null ? ", '" . $identifier->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
