...
$this->assign('title', __('Edit') . ' ' . __('Album'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Album') ?></h3>
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<div class="mb-3 form-group row number required">
												...
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
													<?= $this->Form->control('year', ['type' => 'number', 'class' => 'form-control', 'placeholder' => __('Year'), 'data-decimals' => '0', 'min' => '0', 'max' => '999999999999', 'step' => '1', 'empty' => false]); ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last-used'<?= $album->last_used !== null ? ", '" . $album->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
