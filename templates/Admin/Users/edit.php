								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 1. SELECT: usergroup_id: integer  required -->
											<div class="mb-3 form-group row select required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="usergroup-id"><?= __('Usergroup Id') ?>:</label>
												<div class="col-md-4">
													<?= $this->Form->control('usergroup_id', ['options' => $usergroups, 'placeholder' => __('Usergroup Id'), 'class' => 'form-control select2', 'data-live-search' => false, 'data-container' => 'body', 'data-size' => '6', 'empty' => false]);	?>
											...
											<!-- 2. STRING: token: string  required -->
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="token"><?= __('Token') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('token', ['label' => __('Token'), 'placeholder' => __('Token'), 'class' => 'form-control', 'empty' => false]); ?>

												</div>
											</div>

											<!-- 4. DATETIME: token_expire: datetime  required -->
											<div class="mb-3 row required">
												<label class="pt-2 col-form-label col-md-2 pt-1 text-start text-md-end required" for="token-expire"><?= __('Token Expire') ?>:</label>
												<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 col-xxl-4">
													<div class="form-group datetime">
														<div class="input-group token-expire" id="token-expire" data-target-input="nearest">
															<?= $this->Form->control('token_expire', ['type' => 'text', 'placeholder' => __('Token Expire'), 'class' => 'form-control', 'empty' => false]); ?>

															<div class="input-group-append" data-target="#token-expire" data-toggle="token-expire">
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('token_expire'<?= $user->token_expire !== null ? ", '" . $user->token_expire->format('Y-m-d H:i:s') . "'" : "" ?>)
