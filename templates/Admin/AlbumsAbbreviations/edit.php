...
$this->assign('title', __('Edit') . ' ' . __('Albums Abbreviation'));
?>
				<div id="form-row" class="albumsAbbreviations row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Albums Abbreviation') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($albumsAbbreviation, ['id' => 'main-form']) ?>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	jeffAdminInitDateTimePicker('last_used'<?= $albumsAbbreviation->last_used !== null ? ", '" . $albumsAbbreviation->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
