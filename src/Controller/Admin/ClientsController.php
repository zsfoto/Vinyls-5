...
class ClientsController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		$this->paginate['Clients']['page'] 	= $page;
		...
		if($search !== ''){
			...
			$query = $this->Clients->find()->contain(['Users'])->where($conditions);
		}
		// ############################# /.QUERY ###########################################
    ...
    public function add()
    {
        ...
        $users = $this->Clients->Users->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
    ...
    public function edit($id = null)
    {
        ...
        $users = $this->Clients->Users->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
		$name = $client->name;
        $this->set(compact('client', 'users', 'id', 'name'));
    }
