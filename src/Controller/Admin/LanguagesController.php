...
class LanguagesController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		$this->set('title', __('Browse the') . ': ' . __('Languages'));
		...
		$this->paginate['Languages']['page'] 	= $page;
		$this->paginate['Languages']['order'] 	= [$sort => $direction];
		// ############################# /.SORT ORDER & PAGE ###############################
		...
		if($search !== ''){
			...
			$query = $this->Languages->find()->where($conditions);
		}
		// ############################# /.QUERY ###########################################
		...
		// ############################# PAGINATE ############################################
		try {
			$this->paginate['Languages']['limit'] = $this->config['paginate_limit'];
    ...
    public function view($id = null)
    {
		...
		$this->set('title', __('View the') . ': ' . __('language') . ' ' . __('record'));
        $language = $this->Languages->get($id, contain: ['Albums']);
    ...
    public function add()
    {
		...
		$this->set('title', __('Add new') . ': ' . __('language') . ' ' . __('record'));
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Languages->save($language)) {
                //$this->Flash->success(__('The language has been saved.'), ['plugin' => 'JeffAdmin5']);
            ...
            //$this->Flash->error(__('The language could not be saved. Please, try again.'), ['plugin' => 'JeffAdmin5']);
            $this->Flash->error(__('The save has been not. Please check the datas and try again.'), ['plugin' => 'JeffAdmin5']);
        }
        $albums = $this->Languages->Albums->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
        $this->set(compact('language', 'albums'));
    }
    ...
    public function edit($id = null)
    {
		...
		$this->set('title', __('Edit the') . ': ' . __('language') . ' ' . __('record'));
		$this->session->write('Layout.' . $this->controller . '.LastId', $id);
        ...
        $albums = $this->Languages->Albums->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
		$name = $language->name;
        $this->set(compact('language', 'albums', 'id', 'name'));
    }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Languages->delete($language)) {
            ...
            //$this->Flash->success(__('The language has been deleted.'), ['plugin' => 'JeffAdmin5']);
            $this->Flash->success(__('The has been deleted.'), ['plugin' => 'JeffAdmin5']);
        } else {
            //$this->Flash->error(__('The language could not be deleted. Please, try again.'), ['plugin' => 'JeffAdmin5']);
