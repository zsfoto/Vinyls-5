...
class CompaniesController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		if($search !== ''){
			...
			$query = $this->Companies->find()->where($conditions);
		}
		// ############################# /.QUERY ###########################################
    ...
    public function view($id = null)
    {
        ...
        $company = $this->Companies->get($id, contain: ['Albums']);
    ...
    public function add()
    {
        ...
        $albums = $this->Companies->Albums->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
        $this->set(compact('company', 'albums'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $albums = $this->Companies->Albums->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
		$name = $company->name;
        $this->set(compact('company', 'albums', 'id', 'name'));
    }
