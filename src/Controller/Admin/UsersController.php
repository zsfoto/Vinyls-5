...
class UsersController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		if($search !== ''){
			...
			$query = $this->Users->find()->contain(['Usergroups'])->where($conditions);
		}
		// ############################# /.QUERY ###########################################
    ...
    public function view($id = null)
    {
        ...
        $user = $this->Users->get($id, contain: ['Usergroups', 'Albums', 'Clients', 'Shelves']);
    ...
    public function add()
    {
        ...
        $usergroups = $this->Users->Usergroups->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
        $albums = $this->Users->Albums->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
        $this->set(compact('user', 'usergroups', 'albums'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $user = $this->Users->get($id, contain: ['Albums']);
        ...
        $albums = $this->Users->Albums->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
		$name = $user->name;
        $this->set(compact('user', 'usergroups', 'albums', 'id', 'name'));
    }
